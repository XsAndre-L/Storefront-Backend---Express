...
describe("Product Model-Tests", () => {
    ...
    it("Delete Product | Delete product", async () => {
        ...
        try {
            ...
            expect(error.message).toEqual("Error when retrieving item | No item with that id");
        }
    })
    ...
    it("Get Product | Details of existing product", async () => {
        ...
        // console.log(apple);
        const shouldEqual = { id: 1, name: 'apple', price: 5, category: 'fruit', popularity: 0 };
    ...
    it("Product Model | Add Invalid Product", async () => {
        ...
        try {
            ...
            expect(error.message).toEqual("Error while creating product | Invalid Product Name");
        }
    })
    ...
    it("Product Model | Remove Invalid Product", async () => {
        try {
            ...
            expect(error.message).toEqual("Error While Removing Item | Item Does Not Exist");
        }
    })
    ...
    it("Product Model | Add Duplicate Product Blocking", async () => {
        ...
        try {
            ...
            expect(error.message).toEqual("Error while creating product | Product was already added to the shop");
        }
    })
